...
class Endpoint(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description='User-provided description of the endpoint'
    )
    endpointForwardingRule: Optional[str] = Field(
        None,
        description="Output only. The fully qualified URL of the endpoint's ILB Forwarding Rule.",
    )
    endpointIp: Optional[str] = Field(
        None, description="Output only. The IP address of the IDS Endpoint's ILB."
    )
    labels: Optional[Dict[str, str]] = Field(
        None, description='The labels of the endpoint.'
    )
    name: Optional[str] = Field(
        None, description='Output only. The name of the endpoint.'
    )
    ...
    state: Optional[State] = Field(
        None, description='Output only. Current state of the endpoint.'
    )
    threatExceptions: Optional[List[str]] = Field(
        None, description='List of threat IDs to be excepted from generating alerts.'
    )
    trafficLogs: Optional[bool] = Field(
        None,
...
class ListEndpointsResponse(BaseModel):
    endpoints: Optional[List[Endpoint]] = Field(
        None, description='The list of endpoints response.'
    )
